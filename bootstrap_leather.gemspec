...
# -*- encoding: utf-8 -*-
# stub: bootstrap_leather 0.10.13 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<bootstrap_form>.freeze, [">= 4", "< 6"])
      s.add_development_dependency(%q<bundler>.freeze, [">= 2", "< 3"])
      s.add_development_dependency(%q<juwelier>.freeze, ["~> 2"])
      s.add_development_dependency(%q<rspec>.freeze, [">= 3.5.0", "< 4"])
      s.add_development_dependency(%q<rubocop>.freeze, [">= 0.48", "< 1"])
      s.add_development_dependency(%q<bootstrap-sass>.freeze, ["~> 3.3"])
      s.add_development_dependency(%q<byebug>.freeze, [">= 9", "< 12"])
      s.add_development_dependency(%q<factory_bot>.freeze, [">= 4", "< 6"])
      s.add_development_dependency(%q<faker>.freeze, [">= 1.4", "< 3"])
      ...
      s.add_dependency(%q<bootstrap_form>.freeze, [">= 4", "< 6"])
      s.add_dependency(%q<bundler>.freeze, [">= 2", "< 3"])
      s.add_dependency(%q<juwelier>.freeze, ["~> 2"])
      s.add_dependency(%q<rspec>.freeze, [">= 3.5.0", "< 4"])
      s.add_dependency(%q<rubocop>.freeze, [">= 0.48", "< 1"])
      s.add_dependency(%q<bootstrap-sass>.freeze, ["~> 3.3"])
      s.add_dependency(%q<byebug>.freeze, [">= 9", "< 12"])
      s.add_dependency(%q<factory_bot>.freeze, [">= 4", "< 6"])
      s.add_dependency(%q<faker>.freeze, [">= 1.4", "< 3"])
